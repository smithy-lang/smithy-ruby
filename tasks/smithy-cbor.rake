...
namespace 'smithy-cbor' do
  ...
  task 'rbs:validate' do
    sh('bundle exec rbs -r delegate -I gems/smithy-cbor/sig -I gems/smithy-schema/sig validate')
  end
  ...
  task 'rbs:test' do
    env = {
      ...
      'RBS_TEST_OPT' => '-r delegate -I gems/smithy-cbor/sig -I gems/smithy-schema/sig',
