  ...
  ['generated client gem', 'generated client from source code'].each do |context|
    context context do
      ...
      it 'assigns synthetic input and output shapes to the operation' do
        ...
        expect(operation.input.target.type).to eq(SyntheticInputOutput::Types::OperationInput)
        expect(operation.output.target.type).to eq(SyntheticInputOutput::Types::OperationOutput)
      end
