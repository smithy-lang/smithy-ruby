    ...
    module RpcV2Cbor
      ...
      class Handler < Client::Handler
        ...
        def parse_body(context)
          Cbor::Parser.new(context.operation.output).parse(context.http_response.body.read)
        end
        ...
        def apply_body(context)
          context.http_request.body = Cbor::Builder.new(context.operation.input).build(context.params)
        end
