  ...
  module Stubs
    ...
    class CreateHighScore
      ...
      def self.stub(http_resp, stub:)
        ...
        http_resp.headers['Location'] = stub[:location].to_s unless stub[
          :location
        ].nil?

        http_resp.headers['Content-Type'] = 'application/json'
        data = Stubs::HighScoreAttributes.stub(stub[:high_score]) unless stub[
          :high_score
        ].nil?
        data ||= {}
    ...
    class HighScoreAttributes
      ...
      def self.stub(stub = {})
        ...
        data[:created_at] =
          Seahorse::TimeHelper.to_date_time(stub[:created_at]) unless stub[
          :created_at
        ].nil?
        data[:updated_at] =
          Seahorse::TimeHelper.to_date_time(stub[:updated_at]) unless stub[
          :updated_at
        ].nil?
        data[:simple_list] =
          Stubs::SimpleList.stub(stub[:simple_list]) unless stub[:simple_list]
          .nil?
        data[:complex_list] =
          Stubs::ComplexList.stub(stub[:complex_list]) unless stub[
          :complex_list
        ].nil?
        data[:simple_map] =
          Stubs::SimpleMap.stub(stub[:simple_map]) unless stub[:simple_map].nil?
        data[:complex_map] =
          Stubs::ComplexMap.stub(stub[:complex_map]) unless stub[:complex_map]
          .nil?
        data[:simple_set] =
          Stubs::SimpleSet.stub(stub[:simple_set]) unless stub[:simple_set].nil?
        data[:complex_set] =
          Stubs::ComplexSet.stub(stub[:complex_set]) unless stub[:complex_set]
          .nil?
        data[:event_stream] =
          Stubs::EventStream.stub(stub[:event_stream]) unless stub[
          :event_stream
        ].nil?
        data
      end
    ...
    class EventStream
      ...
      def self.stub(stub = {})
        data = {}
        data[:start] = Stubs::StructuredEvent.stub(stub[:start]) unless stub[
          :start
        ].nil?
        data[:end] = Stubs::StructuredEvent.stub(stub[:end]) unless stub[:end]
          .nil?
    ...
    class SimpleList
      ...
      def self.stub(stub = [])
        data = []
        stub.each { |element| data << element unless element.nil? }
        data
      end
    end
    ...
    class SimpleMap
      ...
      def self.stub(stub = {})
        data = {}
        stub.each { |key, value| data[key] = value unless value.nil? }
        data
      end
    end
    ...
    class ListHighScores
      ...
      def self.stub(http_resp, stub:)
        ...
        data[:high_scores] =
          Stubs::HighScores.stub(stub[:high_scores]) unless stub[:high_scores]
          .nil?
        http_resp.body = StringIO.new(Seahorse::JSON.dump(data))
      end
    end
