  ...
  module Validators
    ...
    class CreateHighScoreInput
      def self.validate!(input, context:)
        Seahorse::Validator.validate!(input, Types::CreateHighScoreInput, context: context)
    ...
    class DeleteHighScoreInput
      def self.validate!(input, context:)
        Seahorse::Validator.validate!(input, Types::DeleteHighScoreInput, context: context)
    ...
    class GetHighScoreInput
      def self.validate!(input, context:)
        Seahorse::Validator.validate!(input, Types::GetHighScoreInput, context: context)
        Seahorse::Validator.validate!(input[:id], ::String, context: "#{context}[:id]")
      end
    end
    ...
    class HighScoreParams
      def self.validate!(input, context:)
        Seahorse::Validator.validate!(input, Types::HighScoreParams, context: context)
    ...
    class UpdateHighScoreInput
      def self.validate!(input, context:)
        Seahorse::Validator.validate!(input, Types::UpdateHighScoreInput, context: context)
        Seahorse::Validator.validate!(input[:id], ::String, context: "#{context}[:id]")
        Validators::HighScoreParams.validate!(input[:high_score], context: "#{context}[:high_score]") unless input[:high_score].nil?
      end
    end
