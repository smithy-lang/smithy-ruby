...
module Hearth
  ...
  # from this class and implement the hooks you want to use.
  #
  class Interceptor
    ...
    #
    # Available Information: The {Interceptor::Context#input} is ALWAYS
    ...
    # {Output#error} in {Interceptor::Context#output}.
    #
    # @param [Interceptor::Context] context
    ...
    #
    # Available Information: The {Interceptor::Context#input} is
    ...
    # very close to the amount of time spent marshalling the request.
    #
    # Available Information: The {Interceptor::Context#input},
    # {Interceptor::Context#request} are ALWAYS available. Other
    ...
    # failure occurs earlier in the request pipeline.
    #
    # Available Information: The {Interceptor::Context#input} and
    # {Interceptor::Context#request} are ALWAYS available. Other
    # information WILL NOT be available.
    #
    # Error Behavior: If errors are raised by this hook, execution will
    ...
    # {Interceptor::Context} WILL include changes made in previous
    ...
    #
    # Available Information: The {Interceptor::Context#input} and
    # {Interceptor::Context#request} are ALWAYS available. The request may
    ...
    # available. In the event of retries, the {Interceptor::Context} WILL
    ...
    # the {Output#error} in {Interceptor::Context#output}.
    #
    # @param [Interceptor::Context] context
    ...
    #
    # Available Information: The {Interceptor::Context#input},
    # {Interceptor::Context#request}, and {Interceptor::Context#response}
    # are ALWAYS available. Other information WILL NOT be available. In the
    # event of retries, the {Interceptor::Context} WILL include changes
    ...
    # retries, the {Interceptor::Context} WILL include changes made in
    ...
    #
    # Available Information: The {Interceptor::Context#input},
    # {Interceptor::Context#request}, {Interceptor::Context#response}
    # and {Interceptor::Context#output} are ALWAYS available. In the event
    # of retries, the {Interceptor::Context} WILL include changes made
    ...
    #
    # Available Information: The {Interceptor::Context#input},
    # {Interceptor::Context#request}, {Interceptor::Context#response} and
    # {Interceptor::Context#output} are ALWAYS available. In the event
    # of retries, the {Interceptor::Context} WILL include changes made
    # in previous attempts (e.g. by other interceptors).
    #
    # Error Behavior: If errors are raised by this hook, execution will
    ...
    # Available Information: The {Interceptor::Context#input},
    # {Interceptor::Context#request}, {Interceptor::Context#response} and
    # {Interceptor::Context#output} are ALWAYS available. The
    # {Interceptor::Context#response} is available if a response
    # was received by the service for this attempt. In the event of retries,
    # the {Interceptor::Context} WILL include changes made in previous
    # attempts (e.g. by other interceptors).
    #
    # Error Behavior: Errors raised by this hook will be stored
