    ...
    describe HTTPApiKey do
      ...
      describe '#scheme_id' do
        it 'returns the scheme_id' do
          expect(subject.scheme_id).to eq('smithy.api#httpApiKeyAuth')
        end
      end

      describe '#signer' do
        it 'returns a signer' do
          expect(subject.signer).to be_a(Signers::HTTPApiKey)
        end
      end
      ...
      describe '#identity_provider' do
        ...
        it 'returns an identity resolver using identity_type' do
          identity_providers = { Identities::HTTPApiKey => identity_provider }
