...
module Weather
  ...
  module Schema
    ...
    CityCoordinates.add_member(:latitude, ShapeRef.new(shape: Smithy::Schema::Shapes::Prelude::Float, member_name: 'latitude', traits: {"smithy.api#required" => {}}))
    CityCoordinates.add_member(:longitude, ShapeRef.new(shape: Smithy::Schema::Shapes::Prelude::Float, member_name: 'longitude', traits: {"smithy.api#required" => {}}))
    ...
    CitySummary.add_member(:name, ShapeRef.new(shape: Smithy::Schema::Shapes::Prelude::String, member_name: 'name', traits: {"smithy.api#required" => {}}))
    ...
    GetCityOutput.add_member(:name, ShapeRef.new(shape: Smithy::Schema::Shapes::Prelude::String, member_name: 'name', traits: {"smithy.api#notProperty" => {}, "smithy.api#required" => {}}))
    ...
    GetCurrentTimeOutput.add_member(:time, ShapeRef.new(shape: Smithy::Schema::Shapes::Prelude::Timestamp, member_name: 'time', traits: {"smithy.api#required" => {}}))
    ...
    GetForecastOutput.add_member(:chance_of_rain, ShapeRef.new(shape: Smithy::Schema::Shapes::Prelude::Float, member_name: 'chanceOfRain'))
    GetForecastOutput.type = Types::GetForecastOutput
    ListCitiesInput.add_member(:next_token, ShapeRef.new(shape: Smithy::Schema::Shapes::Prelude::String, member_name: 'nextToken'))
    ListCitiesInput.add_member(:page_size, ShapeRef.new(shape: Smithy::Schema::Shapes::Prelude::Integer, member_name: 'pageSize'))
    ListCitiesInput.type = Types::ListCitiesInput
    ListCitiesOutput.add_member(:next_token, ShapeRef.new(shape: Smithy::Schema::Shapes::Prelude::String, member_name: 'nextToken'))
    ...
    NoSuchResource.add_member(:resource_type, ShapeRef.new(shape: Smithy::Schema::Shapes::Prelude::String, member_name: 'resourceType', traits: {"smithy.api#required" => {}}))
    ...
    Weather = ServiceShape.new do |service|
      ...
      service.add_operation(:get_current_time, OperationShape.new do |operation|
        ...
        operation.input = ShapeRef.new(shape: Smithy::Schema::Shapes::Prelude::Unit)
