...
module Weather
  ...
  module Schema
    ...
    CityCoordinates.add_member(:latitude, ::Smithy::Schema::Shapes::MemberShape.new(target: ::Smithy::Schema::Shapes::Prelude::Float, model_name: "latitude", traits: {"smithy.api#required" => {}}))
    CityCoordinates.add_member(:longitude, ::Smithy::Schema::Shapes::MemberShape.new(target: ::Smithy::Schema::Shapes::Prelude::Float, model_name: "longitude", traits: {"smithy.api#required" => {}}))
    CityCoordinates.type = Types::CityCoordinates
    CitySummaries.member = ::Smithy::Schema::Shapes::MemberShape.new(target: CitySummary)
    CitySummary.add_member(:city_id, ::Smithy::Schema::Shapes::MemberShape.new(target: CityId, model_name: "cityId", traits: {"smithy.api#required" => {}}))
    CitySummary.add_member(:name, ::Smithy::Schema::Shapes::MemberShape.new(target: ::Smithy::Schema::Shapes::Prelude::String, model_name: "name", traits: {"smithy.api#required" => {}}))
    CitySummary.type = Types::CitySummary
    GetCityInput.add_member(:city_id, ::Smithy::Schema::Shapes::MemberShape.new(target: CityId, model_name: "cityId", traits: {"smithy.api#required" => {}}))
    GetCityInput.type = Types::GetCityInput
    GetCityOutput.add_member(:name, ::Smithy::Schema::Shapes::MemberShape.new(target: ::Smithy::Schema::Shapes::Prelude::String, model_name: "name", traits: {"smithy.api#notProperty" => {}, "smithy.api#required" => {}}))
    GetCityOutput.add_member(:coordinates, ::Smithy::Schema::Shapes::MemberShape.new(target: CityCoordinates, model_name: "coordinates", traits: {"smithy.api#required" => {}}))
    GetCityOutput.type = Types::GetCityOutput
    GetCurrentTimeOutput.add_member(:time, ::Smithy::Schema::Shapes::MemberShape.new(target: ::Smithy::Schema::Shapes::Prelude::Timestamp, model_name: "time", traits: {"smithy.api#required" => {}}))
    GetCurrentTimeOutput.type = Types::GetCurrentTimeOutput
    GetForecastInput.add_member(:city_id, ::Smithy::Schema::Shapes::MemberShape.new(target: CityId, model_name: "cityId", traits: {"smithy.api#required" => {}}))
    GetForecastInput.type = Types::GetForecastInput
    GetForecastOutput.add_member(:chance_of_rain, ::Smithy::Schema::Shapes::MemberShape.new(target: ::Smithy::Schema::Shapes::Prelude::Float, model_name: "chanceOfRain"))
    GetForecastOutput.type = Types::GetForecastOutput
    ListCitiesInput.add_member(:next_token, ::Smithy::Schema::Shapes::MemberShape.new(target: ::Smithy::Schema::Shapes::Prelude::String, model_name: "nextToken"))
    ListCitiesInput.add_member(:page_size, ::Smithy::Schema::Shapes::MemberShape.new(target: ::Smithy::Schema::Shapes::Prelude::Integer, model_name: "pageSize"))
    ListCitiesInput.type = Types::ListCitiesInput
    ListCitiesOutput.add_member(:next_token, ::Smithy::Schema::Shapes::MemberShape.new(target: ::Smithy::Schema::Shapes::Prelude::String, model_name: "nextToken"))
    ListCitiesOutput.add_member(:items, ::Smithy::Schema::Shapes::MemberShape.new(target: CitySummaries, model_name: "items", traits: {"smithy.api#required" => {}}))
    ListCitiesOutput.type = Types::ListCitiesOutput
    NoSuchResource.add_member(:resource_type, ::Smithy::Schema::Shapes::MemberShape.new(target: ::Smithy::Schema::Shapes::Prelude::String, model_name: "resourceType", traits: {"smithy.api#required" => {}}))
