...
module ShapeService
  ...
  module Schema
    ...
    TYPE_REGISTRY = Smithy::Schema::TypeRegistry.new('smithy.ruby.tests#OperationInputOutput' => OperationInputOutput, 'smithy.ruby.tests#Structure' => Structure, 'smithy.ruby.tests#Union' => Union)
  end
end
