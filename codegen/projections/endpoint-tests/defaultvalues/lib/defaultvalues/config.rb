...
module DefaultValues
  ...
  #   @option args [String] :bar
  #     a client string parameter
  #   @option args [String] :baz
  #     another client string parameter
  ...
  Config = ::Struct.new(
    ...
    def validate!
      ...
      Hearth::Validator.validate_types!(bar, String, context: 'config[:bar]')
      Hearth::Validator.validate_types!(baz, String, context: 'config[:baz]')
