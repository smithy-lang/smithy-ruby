...
module UrlEncode
  ...
  #   @option args [String] :input
  #     The input used to test uriEncoder
  ...
  #   @option args [String] :test_case_id
  #     Test case id used to select the test case to use
  ...
  Config = ::Struct.new(
    ...
    def validate!
      ...
      Hearth::Validator.validate_types!(input, String, context: 'config[:input]')
      ...
      Hearth::Validator.validate_types!(test_case_id, String, context: 'config[:test_case_id]')
