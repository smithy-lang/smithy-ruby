...
module RailsJson
  ...
  class Client < Hearth::Client
    ...
    #   resp.data.doc_valued_map #=> Hash<Symbol, Hash, Array, String, Boolean, Numeric>
    ...
    #   resp.data.foo #=> String
    #   resp.data.foo_map #=> Hash<Symbol, String>
    ...
    #   resp.data.prefix_headers #=> Hash<Symbol, String>
    ...
    #   resp.data.foo_enum_map #=> Hash<Symbol, String>
    ...
    #   resp.data.integer_enum_map #=> Hash<Symbol, Integer>
    ...
    #   resp.data.contents.map_value #=> Hash<Symbol, String>
    ...
    #   resp.data.dialog_map #=> Hash<Symbol, Dialog>
