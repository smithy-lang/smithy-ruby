...
module WhiteLabel
  ...
  Config = ::Struct.new(
    ...
    def validate!
      ...
      Hearth::Validator.validate_range!(request_min_compression_size_bytes, min: 0, max: 100, context: 'config[:request_min_compression_size_bytes]')
      Hearth::Validator.validate_range!(request_min_compression_size_bytes, min: 20, max: 20000, context: 'config[:request_min_compression_size_bytes]')
