...
public class HttpDigestAuthScheme implements AuthScheme {
    public ShapeId getShapeId() {
        return HttpDigestAuthTrait.ID;
    }

    public String rubyAuthScheme() {
        return Hearth.AUTH_SCHEMES + "::HTTPDigest.new";
    }
    ...
    public String rubyStubbedIdentity() {
        return Hearth.IDENTITIES + "::HTTPLogin.new(username: 'stubbed username', password: 'stubbed password')";
    }
