...
public final class EventStreamContentTypeMiddlewareFactory {

    private EventStreamContentTypeMiddlewareFactory() {

    }

    public static Middleware build(GenerationContext context) {
        return Middleware.builder()
                .klass(Hearth.EVENT_STREAM_CONTENT_TYPE_MIDDLEWARE)
