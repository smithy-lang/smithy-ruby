...
tasks.register<Copy>("copyGem") {
    from("$buildDir/smithyprojections/smithy-ruby-rails-codegen-test/sample-service/ruby-codegen")
    into("$buildDir/../../../")
}
tasks.register<Copy>("copyIntegrationSpecs") {
    from("./integration-specs")
    into("$buildDir/smithyprojections/smithy-ruby-rails-codegen-test/sample-service/ruby-codegen/sample_service/spec")
}
