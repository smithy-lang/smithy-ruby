...
apply MalformedEnum @httpMalformedRequestTests([
    {
        id: "RailsJsonMalformedEnumString",
        documentation: """
    ...
    {
        id: "RailsJsonMalformedEnumTraitString",
        documentation: """
        When a string member does not contain a valid enum value,
        the response should be a 400 ValidationException. Internal-only
        enum values are excluded from the response message.""",
    ...
    {
        id: "RailsJsonMalformedEnumMapKey",
        documentation: """
    ...
    {
        id: "RailsJsonMalformedEnumMapValue",
        documentation: """
    ...
    {
        id: "RailsJsonMalformedEnumUnion",
        documentation: """
