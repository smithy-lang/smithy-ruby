...
apply MalformedPattern @httpMalformedRequestTests([
    {
        id: "RailsJsonMalformedPatternString",
        documentation: """
    ...
    {
        id: "RailsJsonMalformedPatternReDOSString",
        documentation: """
    ...
    {
        id: "RailsJsonMalformedPatternList",
        documentation: """
    ...
    {
        id: "RailsJsonMalformedPatternMapKey",
        documentation: """
    ...
    {
        id: "RailsJsonMalformedPatternMapValue",
        documentation: """
    ...
    {
        id: "RailsJsonMalformedPatternUnion",
        documentation: """
...
apply MalformedPatternOverride @httpMalformedRequestTests([
    {
        id: "RailsJsonMalformedPatternStringOverride",
        documentation: """
        When a string member does not match the specified pattern,
        the response should be a 400 ValidationException.""",
        protocol: railsJson,
    ...
    {
        id: "RailsJsonMalformedPatternListOverride",
        documentation: """
        When a list member value does not match the specified pattern,
        the response should be a 400 ValidationException.""",
        protocol: railsJson,
    ...
    {
        id: "RailsJsonMalformedPatternMapKeyOverride",
        documentation: """
        When a map member's key does not match the specified pattern,
        the response should be a 400 ValidationException.""",
        protocol: railsJson,
    ...
    {
        id: "RailsJsonMalformedPatternMapValueOverride",
        documentation: """
        When a map member's value does not match the specified pattern,
        the response should be a 400 ValidationException.""",
        protocol: railsJson,
    ...
    {
        id: "RailsJsonMalformedPatternUnionOverride",
        documentation: """
        When a union member's value does not match the specified pattern,
        the response should be a 400 ValidationException.""",
        protocol: railsJson,
