...
apply MalformedLength @httpMalformedRequestTests([
    {
        id: "RailsJsonMalformedLengthBlob",
        documentation: """
    ...
    {
        id: "RailsJsonMalformedLengthString",
        documentation: """
    ...
    {
        id: "RailsJsonMalformedLengthMinString",
        documentation: """
        When a string member does not fit within length bounds,
        the response should be a 400 ValidationException.""",
        protocol: railsJson,
    ...
    {
        id: "RailsJsonMalformedLengthMaxString",
        documentation: """
        When a string member does not fit within length bounds,
        the response should be a 400 ValidationException.""",
        protocol: railsJson,
    ...
    {
        id: "RailsJsonMalformedLengthList",
        documentation: """
    ...
    {
        id: "RailsJsonMalformedLengthListValue",
        documentation: """
    ...
    {
        id: "RailsJsonMalformedLengthMap",
        documentation: """
    ...
    {
        id: "RailsJsonMalformedLengthMapKey",
        documentation: """
    ...
    {
        id: "RailsJsonMalformedLengthMapValue",
        documentation: """
...
apply MalformedLengthOverride @httpMalformedRequestTests([
    {
        id: "RailsJsonMalformedLengthBlobOverride",
        documentation: """
        When a blob member does not fit within length bounds,
        the response should be a 400 ValidationException.""",
        protocol: railsJson,
    ...
    {
        id: "RailsJsonMalformedLengthStringOverride",
        documentation: """
        When a string member does not fit within length bounds,
        the response should be a 400 ValidationException.""",
        protocol: railsJson,
    ...
    {
        id: "RailsJsonMalformedLengthMinStringOverride",
        documentation: """
        When a string member does not fit within length bounds,
        the response should be a 400 ValidationException.""",
        protocol: railsJson,
    ...
    {
        id: "RailsJsonMalformedLengthMaxStringOverride",
        documentation: """
        When a string member does not fit within length bounds,
        the response should be a 400 ValidationException.""",
        protocol: railsJson,
    ...
    {
        id: "RailsJsonMalformedLengthListOverride",
        documentation: """
        When a list member does not fit within length bounds,
        the response should be a 400 ValidationException.""",
        protocol: railsJson,
    ...
    {
        id: "RailsJsonMalformedLengthMapOverride",
        documentation: """
        When a map member does not fit within length bounds,
        the response should be a 400 ValidationException.""",
        protocol: railsJson,
...
apply MalformedLengthQueryString @httpMalformedRequestTests([
    {
        id: "RailsJsonMalformedLengthQueryStringNoValue",
        documentation: """
