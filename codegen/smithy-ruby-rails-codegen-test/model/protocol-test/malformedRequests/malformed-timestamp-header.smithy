...
apply MalformedTimestampHeaderDefault @httpMalformedRequestTests([
    {
        id: "RailsJsonHeaderTimestampDefaultRejectsDateTime",
        documentation: """
    ...
    {
        id: "RailsJsonHeaderTimestampDefaultRejectsEpochSeconds",
        documentation: """
...
apply MalformedTimestampHeaderDateTime @httpMalformedRequestTests([
    {
        id: "RailsJsonHeaderTimestampDateTimeRejectsHttpDate",
        documentation: """
    ...
    {
        id: "RailsJsonHeaderTimestampDateTimeRejectsEpochSeconds",
        documentation: """
    ...
    {
        id: "RailsJsonHeaderTimestampDateTimeRejectsDifferent8601Formats",
        documentation: """
...
apply MalformedTimestampHeaderEpoch @httpMalformedRequestTests([
    {
        id: "RailsJsonHeaderTimestampEpochRejectsDateTime",
        documentation: """
    ...
    {
        id: "RailsJsonHeaderTimestampEpochRejectsHttpDate",
        documentation: """
    ...
    {
        id: "RailsJsonHeaderTimestampEpochRejectsMalformedValues",
        documentation: """
